...
qqnorm(acsdata$SomeCol_pct); qqline(acsdata$SomeCol_pct)
hist(acsdata$SomeCol_pct)
shapiro.test(acsdata$SomeCol_pct)
=======
>>>>>>> a09df36e98d5ccb037a92821af7fc0f7216723d1
```
...
shapiro.test(pollen_data$Juniper)
shapiro.test(pollen_data$Quercus)

wilcox.test(pollen_data$Juniper, pollen_data$Quercus, paired=T)
=======
>>>>>>> a09df36e98d5ccb037a92821af7fc0f7216723d1
```
